...
export const nursing_projects: ProjectData[] = [
    ...
    {
        id: 14,
        name: "Knowledge and Perception of Hypertension and It’s Management Among Pregnant Woman in Central Hospital",
        project_year: "2023",
        project_description: "",
        project_price: "4000",
        ...
        content: {
            backround_of_study: {
                paragraph1: "High blood pressure is referred to as hypertension in medical terminology. High blood pressure (BP), or hypertension is defined by the American college of cardiology/American Heart Association (2017) as “Elevated blood pressure, with a systolic pressure (SBP) between 120mmttg and 129mmttg and diastolic blood pressure (DBP) less than 80mmttg. Hypertension still remains a global, burden till date with prevalence ranging from 4% to 78% recent studies which also shows a crude increase in the last decade especially after year 2000 ( Salem, Hassan, Eameash, Mageed, Hassan& Ali, 2018) In 2010, the first systematic analysis of global health disparity in hypertension revealed that an estimated 1.39bilion people had hypertension with 31.1% of the world adult population affected(Mills, Bundy, Kelly, Reed, Kearney, Reynold, & He 2016). In Nigeria, recent studies still revealed relatively high prevalence of hypertension with a crude prevalence ranging to as high as 17% in children and 47.3% in adult.",
                paragraph2: "",
                paragraph3: "",
                paragraph4: "",
            },
            objective_of_study: {
                paragraph1: "To assess the level of knowledge and perceptions of hypertension among hypertensive women in Central Hospital",
                paragraph2: "To determine the risks factors that leads to hypertension in pregnant women.",
                paragraph3: "To outline the management of hypertension among pregnant women in Central Hospital",
                paragraph4: "",
            },
            research_question: {
                paragraph1: "What is the level of knowledge and perception of hypertension possessed by hypertensive women?",
                paragraph2: "What are the risk factors that leads to hypertension in pregnant women?",
                paragraph3: "What are the management of hypertension among pregnant women?",
                paragraph4: "",
            },
            reference: {
                paragraph1: "Abalos E, Duley L, Steyn DW – Antihypertensive drug therapy for mild to moderate hypertension during pregnancy. Cochrane data base syst Rev. 2014 Feb. CD002255. (QXMD MEDLINECLINK).",
                paragraph2: "Abdul Rahman A., Wang J. G., Yin Wong G.M, Morales A.,Sritara P, and Sukmawan R., Perception of hypertension management by patients and doctors in Asia; Potential to improve blood pressure control, Asia pacific family medicine, 2015; PPLY: 22",
                paragraph3: "Addo J, Smeeth L, Leon D (2017), hypertension in sub-sararan Africa; A systematic review hypertension; 50; 1012-1018.",
                paragraph4: "",
            },
